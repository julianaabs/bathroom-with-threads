...
public class Bathroom extends Thread {
	...
	*/
	...
	/*
	*	Objeto que extende Thread e cria Humans para o banheiro.
	* 
	*/
	...
	public Bathroom(int capacity) {
		try {
			...
			/*
			*	Thread que gera pessoas nas filas.
			*
			*/
			...
			/*
			*	Após 15 segundos, diz para o banheiro esperar todas as pessoas saírem para chamar outro gênero.
			*
			*/
